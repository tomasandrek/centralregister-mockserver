...
def schemes_x_assessors_x__put(schemeId, schemeAssessorId) -> str:
    return 'schemes_x_assessors_x__put schemeId={schemeId} schemeAssessorId={schemeAssessorId}'.format(schemeId=schemeId, schemeAssessorId=schemeAssessorId)
